// A tiny SwiftUI-like declarative layer over the Pebble C API, in Embedded
// Swift. Everything is value types + static generic specialization: Embedded
// Swift has no existentials (`any`), no runtime casts, and cannot call a
// protocol method across a parameter pack, so view composition uses fixed-arity
